...
@section('content')
    ...
    <h1 class="text-center"><i class="fa fa-list-alt">اضافه قسم جديد</i></h1>
    <form role="form" enctype="multipart/form-data" method="post" action="{{url('admin/Categories')}}" class="ls_form"
