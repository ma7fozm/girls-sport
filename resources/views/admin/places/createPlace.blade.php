...
@section('content')
    ...
    <h1 class="text-center"><i class="fa fa-placespaper-o"> اضافة مكان جديد </i></h1>
    <form role="form" enctype="multipart/form-data" method="post" action="{{url('admin/places')}}" class="ls_form"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" name="address" class="form-control active" value="{{old('address')}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10 ls-group-input">
                <input id="file-3" name="placeimg" type="file" value="{{old('placeimg')}}" enctype="multipart/form-data"
