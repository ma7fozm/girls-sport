...
@section('content')
    ...
    <h1 class="text-center"><i class="fa fa-list-alt">إضافه دوري جديد</i></h1>
    <form role="form" enctype="multipart/form-data" method="post" action="{{url('admin/Leagues')}}" class="ls_form"
     ...
     <div class="form-group">
            ...
            <div class="col-md-10 ls-group-input">
                <input id="file-3" name="leagueImg" type="file" value="{{old('leagueImg')}}" enctype="multipart/form-data"
