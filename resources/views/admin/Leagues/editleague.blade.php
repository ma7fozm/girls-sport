...
@section('content')
    ...
    <h1 class="text-center"><i class="fa fa-list-alt">تعديل بيانات الدوري</i></h1>
    <form role="form" enctype="multipart/form-data" method="post" action="{{url('admin/Leagues/'.$league->id)}}"
          class="ls_form"
          style="width: 700px ; margin: 0 auto; ">
        {!! csrf_field() !!}
        {!! method_field('PUT') !!}
        <div class="form-group">
            <label class="col-md-2 control-label">اسم الدوري</label>
            <div class="col-md-10">
                <input type="text" name="name" class="form-control active" value="{{$league->name}}">
            </div>
        </div>
     
   <div class="form-group">
            <label class="col-md-2 control-label">وصف الدوري</label>
            <div class="col-md-10">
                <textarea name="description" class="form-control active">{{$league->description}}</textarea>
            </div>
        </div>
   
  <div class="form-group">
            <label class="col-md-2 control-label">صوره الدوري</label>
            <div class="col-md-10 ls-group-input">
                <div>
                        ...
                        <div class="file-preview">
                            ...
                            <div class="file-preview-thumbnails">
                                <div class="file-preview-frame"><img
                                            src="{{asset($league->image)}}" name="leagueImg"
                    ...
                    <input class="btn btn-ls btn-file" id="file-3" name="leagueImg" type="file" value=""
                           onclick="showDiv()" enctype="multipart/form-data" accept="image/gif, image/jpeg, image/png">
                </div>
            </div>
        </div>
        <div class="form-group">
            <label style="margin-top: 34px;" class="col-sm-2 control-label">حاله الدوري</label>
            <div class="col-sm-10">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="radio-button-place">
                            <label class="radio-inline icheck-radio-inline">
                                <input type="radio" name="status" value="1" {{($league->status == 1)?'checked':''}} >
                                نشط
                            </label>
                            <label style="margin-right: 35px;" class="radio-inline icheck-radio-inline">
                                <input type="radio" name="status" value="0" {{($league->status == 0)?'checked':''}}>
                                غير مفعل
                            </label>
