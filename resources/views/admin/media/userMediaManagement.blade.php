        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h1 class="panel-title">الميديا الخاصة بالاعضاء</h1>
                </div>
                    ...
                    <div class="ls-editable-table table-responsive ls-table">
                        <table class="table table-bordered table-striped" id="ls-editable-table">
                            <div style="text-align:center;">
                                <a href="{{url('admin/media/create')}}" class="btn btn-default"
                                   style="border-radius:10px; font-size: 16px ">
                                    <i style="color: #8B8986" class="fa fa-image"></i> اضافة صورة جديدة </a>
                                       <a href="{{url('admin/video/create')}}" class="btn btn-default"
                                   style="border-radius:10px; font-size: 16px ">
                            ...
                            @foreach($medias as $media)
                                <tr>
                                    ...
                                    <td style="width:160px;" class="text-center">
                                      ...
                                      @if($media->type =='فيديو')
                                       <a href="{{url('admin/video/'.$media->id.'/edit')}}" style="border-radius:5px;"
...
@section('js')
    ...
    <script>
        ...
        function blockFunction() {
            return confirm("هل انت متأكد من عدم تعيل ظهور تلك الميديا بالموقع ؟");
        }
