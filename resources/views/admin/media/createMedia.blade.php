...
@section('content')
    ...
    <h1 class="text-center"> <i class="fa fa-image"> اضافة ميديا الى الاعضاء </i></h1>
    <form id="ffrm" role="form" enctype="multipart/form-data" method="post" action="{{url('admin/media')}}" class="ls_form"
