...
@section('content')
    ...
    <h1 class="text-center"><i class="fa fa-image">إضافه فيديو من موقع يوتيوب  في ميديا الموقع</i></h1>
    <form id="ffrm" role="form" enctype="multipart/form-data" method="post" action="{{url('admin/gallaryVid/store')}}" class="ls_form"
