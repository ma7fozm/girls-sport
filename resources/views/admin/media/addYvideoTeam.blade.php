...
@section('content')
    ...
    <h1 class="text-center"> <i class="fa fa-image">إضافه فيديو إلي فريق</i></h1>
    <form id="ffrm" role="form" enctype="multipart/form-data" method="post" action="{{url('admin/teamsVid/media')}}" class="ls_form"
