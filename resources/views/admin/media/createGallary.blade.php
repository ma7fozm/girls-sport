...
@section('content')
    ...
    <h1 class="text-center"><i class="fa fa-image"> اضافة ميديا الى الموقع </i></h1>
    <form id="ffrm" role="form" enctype="multipart/form-data" method="post" action="{{url('admin/gallary/store')}}" class="ls_form"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10 ls-group-input">
                <select id="drop" class="form-control" name="media_type">
                    ...
                    <option value="صحه" {{(old('media_type') == 'صحه')?'selected':''}}>صحه</option>
                    <option value="رياضه" {{(old('media_type') == 'رياضه')?'selected':''}}>رياضه</option>
                    <option value="لا للفراغ" {{(old('media_type') == 'لا للفراغ')?'selected':''}}>لا للفراغ</option>
                    <option value="عام" {{(old('media_type') == 'عام')?'selected':''}}>عام</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10 ls-group-input">
                <input id="file-3" name="media_file" type="file" value="{{old('media_file')}}" enctype="multipart/form-data"
