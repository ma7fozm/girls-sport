...
@section('content')
    ...
    <h1 class="text-center"><i class="fa fa-image">إضافه فيديو إلي المجموعه</i></h1>
    <form id="ffrm" role="form" enctype="multipart/form-data" method="post" action="{{url('admin/groupsVid/media')}}" class="ls_form"
