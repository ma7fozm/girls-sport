...
@section('content')
    ...
    <form role="form" enctype="multipart/form-data" method="post" action="{{url('admin/eventMedia/'.$media->id)}}"
          class="ls_form"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" readonly name="name" class="form-control active" value="{{$media->name}}">
            </div>
        </div>
        <div class="form-group">
