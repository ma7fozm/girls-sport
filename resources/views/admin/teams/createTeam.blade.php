...
@section('content')
    ...
    <h1 class="text-center"><i class="fa fa-group"> اضافة فريق جديد </i></h1>
    <form role="form" enctype="multipart/form-data" method="post" action="{{url('admin/teams')}}" class="ls_form"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="description" class="form-control active" value="{{old('description')}}"></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
        <label class="col-md-2 control-label">شعار الفريق</label>
        <div class="col-md-10 ls-group-input">
        <input id="file-3" name="teamSlogan" type="file" value="{{old('teamSlogan')}}" enctype="multipart/form-data"
