...
@section('content')
    ...
    <h1 class="text-center"><i class="fa fa-newspaper-o"> تعديل بيانات الخبر </i></h1>
    <form role="form" enctype="multipart/form-data" method="post" action="{{url('admin/news/'.$new->id)}}"
          class="ls_form"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" name="title" class="form-control active" value="{{$new->title}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" name="intro" class="form-control active" value="{{$new->intro}}">
            </div>
        </div>
            ...
            <div class="col-md-10 ls-group-input">
                <select id="drop" class="form-control" name="news_type">
                    <option value="صحه" {{($new->news_type == 'صحه')?'selected':''}}>صحه</option>
                    <option value="رياضه" {{($new->news_type == 'رياضه')?'selected':''}}>رياضه</option>
                    <option value="لا للفراغ" {{($new->news_type == 'لا للفراغ')?'selected':''}}>لا للفراغ</option>
                    <option value="عام" {{($new->news_type == 'عام')?'selected':''}}>عام</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="newContent" class="form-control active">{{$new->content}}</textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10 ls-group-input">
                <div>
                        ...
                        <div class="file-preview">
                            ...
                            <div class="file-preview-thumbnails">
                                <div class="file-preview-frame"><img
                                            src="{{asset($new->image)}}" name="newImg"
                    ...
                    <input class="btn btn-ls btn-file" id="file-3" name="newImg" type="file" value=""
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="radio-button-place">
                            <label class="radio-inline icheck-radio-inline">
                                <input type="radio" name="status" value="1" {{($new->status == 1)?'checked':''}} >
                                نشط
                            </label>
                            <label style="margin-right: 35px;" class="radio-inline icheck-radio-inline">
                                <input type="radio" name="status" value="0" {{($new->status == 0)?'checked':''}}>
                                غير مفعل
                            </label>
