...
@section('content')
    ...
    <h1 class="text-center"><i class="fa fa-user">تعديل بيانات الراعي </i></h1>
    <form role="form" enctype="multipart/form-data" method="post" action="{{url('admin/Sponsors/'.$sponsor->id)}}"
          class="ls_form"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" name="name" class="form-control active" value="{{$sponsor->name}}">
            </div>
        </div>
 ...
 <div class="form-group">
            ...
            <div class="col-md-10 ls-group-input">
                <div>
                        ...
                        <div class="file-preview">
                            ...
                            <div class="file-preview-thumbnails">
                                <div class="file-preview-frame"><img
                                            src="{{asset($sponsor->image)}}" name="sponsorImg"
                    ...
                    <input class="btn btn-ls btn-file" id="file-3" name="sponsorImg" type="file" value=""
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="radio-button-place">
                            <label class="radio-inline icheck-radio-inline">
                                <input type="radio" name="status" value="1" {{($sponsor->status == 1)?'checked':''}} >
                                نشط
                            </label>
                            <label style="margin-right: 35px;" class="radio-inline icheck-radio-inline">
                                <input type="radio" name="status" value="0" {{($sponsor->status == 0)?'checked':''}}>
                                غير مفعل
                            </label>
