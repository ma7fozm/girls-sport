            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 flo-right dir">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 flo-right">
                                            ...
                                            @if(isset(Auth::user()->id))
                                                    @if($comment->added_by->id == Auth::user()->id)
                                                        ...
                                                        <form id="{{'my_form'.$comment->id}}"
                                                              ...
                                                              method="post"
                                                              action="{{url('/video/delete/comment/'.$media->id.'/'.$comment->id)}}">
                                            ...
                                            <div class="dsc-comments">
                                                ...
                                                <div class="add_comm">
                                                    <form method="post"
                                                          action="{{url('/video/add/reply/'.$media->id.'/'.$comment->id)}}">
                                                        {!! csrf_field() !!}
                                            ...
                                            @if(isset(Auth::user()->id))
                                                @if($reply->added_by->id == Auth::user()->id)
                                                    ...
                                                    <form id="{{'my_form'.$reply->id}}" style="display: inline-block;"
                                                          method="post"
                                                          action="{{url('/video/delete/comment/'.$media->id.'/'.$reply->id)}}">
                                                    {!! csrf_field() !!} {!! method_field('DELETE') !!}
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 flo-right leave-comments-area">
                        ...
                        <form method="post"
                              action="{{url('/video/add/comment/'.$media->id)}}">
                            {!! csrf_field() !!}
                            <fieldset>
    ...
    <div class="modal fade" id="exampleModalc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="edit_comment" method="post" action="{{url('/video/edit/comment/')}}">
                    {!! csrf_field() !!}
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" id="customURL" value="{{url('video-details/'.$media->id.'/#scroll')}}">
                    </div>
                </form>
            </div>
        </div>
