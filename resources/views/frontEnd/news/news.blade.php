                                        ...
                                        <div class="item active">
                                            ...
                                            <div class="dsc">
                                                ...
                                                <span class="date"> <i class="fa fa-calendar-check-o flo-right"
                                                                       aria-hidden="true"></i>{{App\Http\Controllers\HomeController::ArabicDate(date('y-m-d', strtotime($news[0]->created_at)))}}</span>
                                        ...
                                        @for($i=1;$i<count($news);$i++)
                                            <div class="item ">
                                                ...
                                                <div class="dsc">
                                                    ...
                                                    <span class="date"> <i class="fa fa-calendar-check-o flo-right"
                                                                           aria-hidden="true"></i>{{ App\Http\Controllers\HomeController::ArabicDate(date('y-m-d', strtotime($news[$i]->created_at)))}}</span>
                                ...
                                @foreach($news as $new)
                                    <li>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <span class="date">{{App\Http\Controllers\HomeController::ArabicDate(date('y-m-d', strtotime($new->created_at)))}}</span>
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td class="text-left"><i class="fa fa-calendar-check-o"
                                                                                 aria-hidden="true"></i>
                                                            {{App\Http\Controllers\HomeController::ArabicDate(date('y-m-d', strtotime($match->date))) }}
                                                        </td>
                                                    </tr>
                                                </table>
                                            </li>
                                    ...
                                    <div class="row">
                                        <div id="championship" class="inner owl-carousel">
                                            @foreach(@$comming_matchs as $match)
                                                ...
                                                <div class="item">
                                                    <span class="date">{{App\Http\Controllers\HomeController::ArabicDate(date('y-m-d', strtotime($match->date)))}}</span>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 flo-right">
                                                        ...
                                                        <span class="radison">{{ App\Http\Controllers\HomeController::ArabicDate(date('y-m-d', strtotime($match->start_time)))}} {{(strpos(date('h:i:s a', strtotime(@$match->start_time)),'pm'))?'م':'ص'}}
                                                            <br> {{$match->place->name}}</span>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                        <div class="inner">
                                                            @if($match->match_type == 'team' )
                                                                <img style="width: 90px;height: 90px;border-radius: 50%;"
                                                                     src="{{asset('/'.@$match->teams[1]['slogan'])}}"
                                                                     alt="">
