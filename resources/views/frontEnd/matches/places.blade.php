                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <i class="fa fa-calendar-check-o" aria-hidden="true"> </i>  {{\Arabicdatetime::date(strtotime(@$event->created_at) , 0 , 'j M Y'  ,'indian')}}  </span><br>
                                ...
                                <li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <span class="admin"><i class="fa fa-user-o" aria-hidden="true"></i> {{$match->added_by->name}} | <i
                                                        class="fa fa-calendar-check-o" aria-hidden="true"> </i> {{\Arabicdatetime::date(strtotime(@$match->created_at) , 0 , 'j M Y'  ,'indian')}}</span> <br>
