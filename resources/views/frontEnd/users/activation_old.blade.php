                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    ...
                    @endif
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label >المدينه</label>
                                         <input class="form-control" value="{{Auth::user()->city}}" readonly  type="text">
                                 ...
                                 <div class="form-group col-md-12 flo-right">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label >البريد الإلكتروني</label>
                                         <input class="form-control"  name="guarantor_email" type="text">

                                    </div> 
                                    <div class="form-group col-md-6">

                                        <label >رقم الجوال</label>
                                         <input class="form-control"  name="guarantor_phone" type="text">

                                    </div>
                               
                                    <div class="form-group btn-register col-md-12">
